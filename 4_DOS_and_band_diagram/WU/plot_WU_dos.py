...
# load DOS data
data = np.loadtxt('ZnO-WU.dos',skiprows=1)
...
E_Fermi = float(open('ZnO-WU.dos','r').readline().split()[-2])
...
plt.savefig('dos_ZnO-WU.pdf',bbox_inches='tight',pad_inches=1/25.4,format='pdf')
