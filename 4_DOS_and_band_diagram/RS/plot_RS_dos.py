...
# load DOS data
data = np.loadtxt('ZnO-RS.dos',skiprows=1)
...
E_Fermi = float(open('ZnO-RS.dos','r').readline().split()[-2])
...
plt.savefig('dos_ZnO-RS.pdf',bbox_inches='tight',pad_inches=1/25.4,format='pdf')
